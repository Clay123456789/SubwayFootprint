...
public class FirstOpen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Treasure digTreasure=(Treasure) bundle.getSerializable("digTreasure");
        Treasure cc=digTreasure;
        ...
        bottomNavigationView.setOnItemSelectedListener((menuItem)->{
            ...
            switch (menuItem.getItemId()){
                case R.id.nav_home:
                    intent1 =new Intent(FirstOpen.this, main_page.class);
                    startActivity(intent1);
                    break;
                case R.id.nav_credit:
                    intent1 =new Intent(FirstOpen.this,Tanjifen_main.class);
                    startActivity(intent1);
                    break;
                case R.id.nav_shop:
                    intent1 =new Intent(FirstOpen.this, PersonalcenterActivity.class);
                    startActivity(intent1);
                    break;
    ...
    public void go_back_to_route2(View view){
        finish();
    }
}