...
public class CartAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        vh=new ViewHolder();
        if(view==null){
            view= LayoutInflater.from(context).inflate(R.layout.buy_history_item,null);
        ...
        if(dataList.size()>0){
            ...
            vh.price.setText("  "+(Double.valueOf(map.get("price")) * Integer.valueOf(map.get("count")))+"碳积分");
